        ...
        <table width="600" cellpadding="0" cellspacing="0" role="presentation"
          ...
          <tr>
            <td align="center" style="padding-bottom:36px;">
              <img src="https://s3.ap-south-1.amazonaws.com/aivy.cloud/AivyCloud.png"
                   alt="Aivy Cloud"
                   width="178"
                   style="display:block;">
            </td>
          ...
          <tr>
            <td align="center"
                ...
                style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;
                       ...
                       color:#b3b3b3;
                       padding-bottom:6px;">
              Aivy Cloud is a certificate generation platform that is a powerful<br>
              web-based tool for creating, issuing and verifying digital credentials.
            </td>
          </tr>
          ...
          <tr>
            <td align="center"
                ...
                style="font-family:'Fira Sans', Arial, Helvetica, sans-serif;
                       font-size:11px;
                       color:#b3b3b3;">
              Aivy Cloud © All rights reserved
            </td>
          </tr>
